...
start_receiver() {
  ...
  socat $SOCAT_DEBUG_LEVEL -u -T $SOCAT_TIMEOUT UDP4-RECVFROM:$MULTICAST_PORT,ip-add-membership=$MULTICAST_ADDRESS:$FROM_IP_OR_INTERFACE,reuseaddr,fork UDP4-SENDTO:$MULTICAST_ADDRESS:$MULTICAST_PORT,fork &
}
